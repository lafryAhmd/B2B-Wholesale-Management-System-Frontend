    ...
    <div style={{display:'flex',flexDirection:'column',minHeight:'100vh',background:'var(--bg)',color:'var(--text)',fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <header className="db-topbar">
        ...
        <div className="db-topright">
          ...
          <div className="db-chip"><div className="db-avatar">AJ</div><span className="db-chip-name">Alex Johnson</span></div>
        </div>
      </header>
      ...
      <div className="db-layout">
        ...
        <aside className="db-sidebar">
          <div className="db-sb-section">
            ...
            <a className="nav-item" href="#"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>Marketplace<span className="nav-count">142</span></a>
          </div>
          <div className="db-sep"></div>
          <div className="db-sb-section">
            <div className="db-sb-label">My Business</div>
            <a className="nav-item" href="#"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>My Listings</a>
          ...
          <div className="db-sb-section">
            ...
            <Link className="nav-item" to="/login" style={{color:'#be123c'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>Sign Out</Link>
          </div>
          <div className="db-sb-footer">
            <div className="db-sb-user">
              <div className="sb-avatar">AJ</div>
              <div><div className="sb-name">Alex Johnson</div><div className="sb-role">Metro Electronics</div></div>
        ...
        <main className="db-main">
          <div className="welcome-bar">
            <div><div className="welcome-text">Good morning, <strong>Alex</strong> 👋 — You have 3 active deals and 5 new messages.</div></div>
